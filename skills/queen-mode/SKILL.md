...
10. 所有子 issue 完成后，启动一次哨蜂，对整个蜂群进行复盘
11. 创建主分支合回用户原分支的 PR，等待用户确认后再合入
12. 主 PR 合入后，将主 issue 标记为完成，并清理蜂群开发创建的 worktree、分支和工作区

## 协调节奏

1. 当某一个 subagent 完成阶段性任务时，判断其运行时间是否过长，若过长则启动一次哨蜂，对其工作进行复盘
